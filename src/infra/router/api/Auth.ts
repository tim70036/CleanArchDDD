...
authRouter.post("/device", (req, res) => {
  identityContainer.resolve(AuthDeviceController).Execute(req, res);
});

authRouter.post("/line", (req, res) => {
  identityContainer.resolve(AuthLineController).Execute(req, res);
});
