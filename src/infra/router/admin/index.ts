...
adminRouter.put('/maintenance/config',
    (req, res) => { cMaintenanceContainer.resolve(SetConfigController).Execute(req, res); }
);

adminRouter.get('/maintenance/config',
    (req, res) => { qMaintenanceContainer.resolve(GetConfigController).Execute(req, res); }
);

adminRouter.post('/maintenance/switch-off',
    (req, res) => { cMaintenanceContainer.resolve(SwitchOffController).Execute(req, res); }
);
