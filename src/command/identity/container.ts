...
identityContainer.register(AuthDeviceController, { useClass: AuthDeviceController });

identityContainer.register(AuthLineUseCase, { useClass: AuthLineUseCase });
identityContainer.register(AuthLineController, { useClass: AuthLineController });

identityContainer.register(EndSessionUseCase, { useClass: EndSessionUseCase });
identityContainer.register(EndSessionController, { useClass: EndSessionController });

identityContainer.register(StartSessionUseCase, { useClass: StartSessionUseCase });
identityContainer.register(StartSessionController, { useClass: StartSessionController });

identityContainer.register<IRegisterService>('IRegisterService', { useClass: RegisterService });
identityContainer.register<ISessionService>('ISessionService', { useClass: SessionService });

identityContainer.register<IUserRepo>('IUserRepo', { useClass: UserRepo });
identityContainer.register<ISessionRepo>('ISessionRepo', { useClass: SessionRepo });
