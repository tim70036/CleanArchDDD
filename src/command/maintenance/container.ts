...
maintenanceContainer.register(SetConfigController, { useClass: SetConfigController });

maintenanceContainer.register(SwitchOffUseCase, { useClass: SwitchOffUseCase });
maintenanceContainer.register(SwitchOffController, { useClass: SwitchOffController });

maintenanceContainer.register<IConfigService>('IConfigService', { useClass: ConfigService });
