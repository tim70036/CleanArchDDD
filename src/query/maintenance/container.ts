...
maintenanceContainer.register(GetConfigController, { useClass: GetConfigController });

maintenanceContainer.register<IGetConfigService>('IGetConfigService', { useClass: GetConfigService });
